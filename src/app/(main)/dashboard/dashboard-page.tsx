...
import { UtensilsCrossed, Bus, Store, Film, Activity, BookText } from "lucide-react";
                ...
                <Card className="p-4 border border-gray-200 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {[
                            ...
                            {
                                img: "/img3.jpg",
                                title: "Campus Recreation Pass",
                                place: "University Gym",
                                price: "$65.00",
                            },
                            {
                                img: "/img4.jpg",
                                title: "Library Premium Access",
                            ...
                            <Card key={i} className="overflow-hidden shadow-md border border-gray-200 rounded-sm">
                                ...
                                <div className="p-4 space-y-1">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <Badge className="bg-blue-600 text-white rounded-sm">{ticket.price}</Badge>
                                    </div>
